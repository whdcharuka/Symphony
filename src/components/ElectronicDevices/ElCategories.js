  ...
  return (
    <>
      ...
      <h3 className='types'>TYPES</h3>
        <div className='box '>
          <ul>
            <Link to="./Phone"><i class="fa fa-square" aria-hidden="true"><span>MOBILE PHONES</span></i></Link>
            <Link to="./Tele"><i class="fa fa-square" aria-hidden="true"><span>TELEVISIONS</span></i></Link>
            <Link to="./Computer"><i class="fa fa-square" aria-hidden="true"><span>COMPUERS</span></i></Link>
